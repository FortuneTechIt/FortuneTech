...
* Added few lines of css to fix font awesome issue.
* Fixed share counter issue.
...
* Removed the fontawsome css file from the plugins css folder.
...
= 1.1.6 =
* Made the share text title translation ready.
